    ...
    return (
      <Swiper style={styles.wrapper} showsButtons={true}>
        ...
        <View style={styles.slideContent}>
          ...
          <Text style={styles.text}>
            COVID-19, also referred to as "Coronavirus" mainly spreads between
            people who are in close contact with one another (within about 6
            feet or two meters) through respiratory droplets produced when an
        ...
        <View style={styles.slideContent}>
          ...
          <Text style={styles.text}>
            ...
            who are at higher risk of getting very sick, including the elderly.
          </Text>
        </View>
      </Swiper>
    );
